...
/* Load Class. */
$Team_Showcase = new Team_Showcase_Updater();

/**
 * Updater Class
 * */
class Team_Showcase_Updater
{
    ...
    public function __construct() {
        /* Updater Config */
        $this->config = array(
            'server' => 'https://updater.wbbdev.com/',
            'type'   => 'plugin',
            'id'     => 'awesome-plugins-team-showcase/awesome-plugins-team-showcase.php',
            'api'    => '1.0.0',
            'post'   => array(),
        );
        /* Admin Init */
